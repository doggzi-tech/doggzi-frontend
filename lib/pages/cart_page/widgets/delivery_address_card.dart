        ...
        children: [
          ...
          ListTile(
            ...
            title: Text("Delivering At",
                style:
                    TextStyles.captionL.copyWith(color: AppColors.darkGrey500)),
            subtitle: Obx(() {
              return Text(
          ...
          ListTile(
            ...
            leading:
                Icon(Icons.call, color: AppColors.darkGrey300, size: 20.sp),
            title: Text("Contact Details",
                style:
                    TextStyles.captionL.copyWith(color: AppColors.darkGrey500)),
            subtitle: Text("Harshita, +91-7631056337",
                style:
                    TextStyles.captionM.copyWith(color: AppColors.darkGrey300)),
            trailing: Icon(Icons.arrow_forward_ios,
                size: 16.sp, color: AppColors.darkGrey300),
          ),
        ],
